...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        api_key = "f7d91613b6d20aacd217b5f0d1434ad9"
        city = self.city_input.text()
        url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid={api_key}"
        Map_url = f"https://tile.openweathermap.org/map/{"precipitation_new"}/{8}/{100}/{100}.png?appid={api_key}"
        ...
        try:
            ...
            match response.status_code:
                case 400:
                    self.display_error("bad requests check your input")
                case 401:
    ...
    def display_forecast(self,data):
        weather = [data["list"][4], data["list"][12], data["list"][20], data["list"][28], data["list"][36]]
        day1 = data["list"][4]["main"]["temp"]
        day2 = data["list"][12]["main"]["temp"]
        day3 = data["list"][20]["main"]["temp"]
        day4 = data["list"][28]["main"]["temp"]
        day5 = data["list"][36]["main"]["temp"]
